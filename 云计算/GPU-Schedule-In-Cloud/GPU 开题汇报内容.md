...
# 0. 描述内容概述
* 第1点介绍云服务现状
* 第2点云游戏发展状况，以及Wine使用GPU部署在云上的调研的可行性
    * （重点）其中整理了当前商汤10个集群GPU利用率，描述了当前GPU利用率的问题，也是我做这个方向的基础
* 第3是准备做的方向，以及所做方向的侧重点
* 第4点是实现路线，以及目前进展状况
# 1. 概述
...
* 总共10个集群，北京5个集群每个集群约700张GPU卡。上海5个集群、每个集群约2000张v100 32 GPU 卡。

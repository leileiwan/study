...
- [2. 概要设计](#2-概要设计)
    ...
    - [2.3 第二层设计描述](#23-第二层设计描述)
        ...
        - [2.3.2 QueueController](#232-queuecontroller)
...
* queue-Controller：是Controller-Manager启动的controller之一。主要是维护queue实例的状态，特别是Resource和Job。
...
#### 2.2.2.2 数据依赖关系
![](./images/2020-05-22-16-51-22.png)
...
#### 2.3.1.2  依赖性描述
##### 2.3.1.2.1 运行设计
![](./images/2020-05-22-16-33-16.png)
##### 2.3.1.2.2 数据依赖关系
![](./images/2020-05-22-17-15-14.png)
### 2.3.2 QueueController
...
* 怎样区分子系统和模块，queue-controller是controller-manager子系统吗？
* 进程接口和并发进程分解看不出很大区别


# 4. 改进
* controller-manager改进：第一层子模块放到第二层
* 数据分解 描述公有数据